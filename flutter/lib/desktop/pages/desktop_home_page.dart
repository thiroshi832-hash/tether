...
import 'package:flutter_hbb/desktop/pages/tether_home_page.dart';
...
class _DesktopHomePageState extends State<DesktopHomePage>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    // Tether: custom sidebar-shell + Remote Control home UI.
    return _buildBlock(child: const TetherHomePage());
  }
